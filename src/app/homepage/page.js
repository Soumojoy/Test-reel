...
import Lightvideo from '../public/light_looped_compressed.mp4'; // assuming your video is in public folder

const GridSection = () => {
  return (
    <div className="relative h-[65vh] overflow-hidden m-2 rounded-2xl">
